...
**Reference / upstream project:** [github.com/be1ani/botbuster](https://github.com/be1ani/botbuster)
...
- [Use case and product vision](#use-case-and-product-vision)
- [Overview](#overview)
- [Repository layout](#repository-layout)
- [Quick start](#quick-start)
- [CLI options](#cli-options)
- [Architecture](#architecture)
- [Documentation graphs](#documentation-graphs)
- [Interaction JSON format](#interaction-json-format)
- [Feature reference](#feature-reference)
  - [1. Time-Based Features](#1-time-based-features)
  - [2. Mouse Movement Features](#2-mouse-movement-features)
  - [3. Click Features](#3-click-features)
  - [4. Scroll Features](#4-scroll-features)
  - [5. Keystroke Features](#5-keystroke-features)
  - [6. Session-Level Features](#6-session-level-features)
  - [Feature Statistics](#feature-statistics)
  - [Why These Features Matter](#why-these-features-matter-for-bot-detection)
  - [Feature Extraction Notes](#feature-extraction-notes)
  - [Total Feature Count](#total-feature-count)
...
3. **Inference** reloads the model, reads the **column order** from the same CSV header the model was trained on, extracts features from the input JSON via the same code path as training data, and emits per-session predictions.
...
![End-to-end pipeline](docs/images/pipeline.png)

![Scripts and package dependencies](docs/images/modules.png)
